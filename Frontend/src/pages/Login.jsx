...
const Login = () => {
  ...
  const [role, setRole] = useState('owner'); // 'owner' or 'employee'
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8 pr-10">
          <div>
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-4 leading-tight">Welcome Back</h1>
            <p className="text-xl text-gray-600 leading-relaxed">Sign in to continue managing your team and tracking productivity with Work Monitor</p>
          </div>
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Monitor work activities in real-time</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Your data is protected and secure</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full">
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-2.5">Sign In</h2>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="p-5 sm:p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl">
              ...
              <div className="text-sm text-blue-800 space-y-4">
                <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                  ...
                  <span className="font-mono text-xs">jatin@gmail.com / 123</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                  <span className="font-semibold">Employee:</span>
                  <span className="font-mono text-xs">jane@example.com / password123</span>
                </div>
              </div>
            </div>
          </div>
